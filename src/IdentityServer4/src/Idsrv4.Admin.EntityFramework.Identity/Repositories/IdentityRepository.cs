...
using Idsrv4.Admin.EntityFramework.Extensions.Enums;
using Idsrv4.Admin.EntityFramework.Extensions.Extensions;
using Idsrv4.Admin.EntityFramework.Identity.Repositories.Interfaces;

namespace Idsrv4.Admin.EntityFramework.Identity.Repositories;
    ...
    where TUserToken : IdentityUserToken<TKey>
{
    ...
    public virtual Task<List<TRole>> GetRolesAsync() => RoleManager.Roles.ToListAsync();
    ...
    public virtual Task<TUser> GetUserAsync(string userId) => UserManager.FindByIdAsync(userId);
