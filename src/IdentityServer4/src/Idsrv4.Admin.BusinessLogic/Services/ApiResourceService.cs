...
using Idsrv4.Admin.BusinessLogic.Events.ApiResource;
using Idsrv4.Admin.BusinessLogic.Mappers;
using Idsrv4.Admin.BusinessLogic.Resources;
...
public class ApiResourceService : IApiResourceService
{
    ...
    public virtual async Task<string> GetApiResourceNameAsync(int apiResourceId)
        => await ApiResourceRepository.GetApiResourceNameAsync(apiResourceId);
