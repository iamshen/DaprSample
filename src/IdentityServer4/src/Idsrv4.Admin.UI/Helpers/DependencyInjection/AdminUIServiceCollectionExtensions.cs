...
{
    /// <summary>
    ///     Adds the IdentityServer4 Admin UI with the default entity model.
    /// </summary>
    ...
    public static IServiceCollection AddIdentityServer4AdminUi<TIdentityDbContext, TIdentityServerDbContext,
        ...
        => AddIdentityServer4AdminUI<TIdentityDbContext, TIdentityServerDbContext, TPersistedGrantDbContext,
