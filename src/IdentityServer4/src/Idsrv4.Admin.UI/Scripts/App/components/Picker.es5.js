...
ko.components.register("picker",
    {
        viewModel: function viewModel(params) {
            ...
            //Labels
            this.searchInputPlaceholder = ko.observable(params.searchInputPlaceholder ||
                "Enter " + this.minSearchText() + " or more characters");
            ...
            this.allowItemAlreadySelectedNotification =
                ko.observable(params.allowItemAlreadySelectedNotification || true);
            ...
            this.update = function(item, newValue) {
                ...
                for (let i = 0; i < self.selectedResult().length; i++) {
