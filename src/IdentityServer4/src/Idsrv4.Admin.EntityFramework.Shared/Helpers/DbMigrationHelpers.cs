...
public static class DbMigrationHelpers
{
    ...
    public static async Task<bool> ApplyDbMigrationsWithDataSeedAsync<TIdentityServerDbContext, TIdentityDbContext,
        ...
        IServiceProvider serviceProvider, bool applyDbMigrationWithDataSeedFromProgramArguments, SeedConfiguration seedConfiguration,
        ...
        where TRole : IdentityRole<Guid>, new()
    {
        ...
        if (databaseMigrationsConfiguration is { ApplyDatabaseMigrations: true } || applyDbMigrationWithDataSeedFromProgramArguments)
            migrationComplete =
        ...
        if (seedConfiguration is not { ApplySeed: true } && !applyDbMigrationWithDataSeedFromProgramArguments)
