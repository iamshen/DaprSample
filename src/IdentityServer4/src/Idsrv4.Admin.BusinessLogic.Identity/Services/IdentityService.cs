...
using Idsrv4.Admin.BusinessLogic.Identity.Events.Identity;
...
using Idsrv4.Admin.BusinessLogic.Shared.ExceptionHandling;
using Idsrv4.Admin.EntityFramework.Identity.Repositories.Interfaces;
using Idsrv4.Admin.AuditLogging.Services;

namespace Idsrv4.Admin.BusinessLogic.Identity.Services;
...
public class IdentityService<TUserDto, TRoleDto, TUser, TRole, TKey, TUserClaim, TUserRole,
    ...
    TRoleClaimDto> : IIdentityService<TUserDto, TRoleDto, TUser, TRole, TKey, TUserClaim, TUserRole,
    TUserLogin, TRoleClaim, TUserToken,
    TUsersDto, TRolesDto, TUserRolesDto, TUserClaimsDto,
