...
using Idsrv4.Admin.BusinessLogic.Identity.Mappers.Configuration;
using Idsrv4.Admin.BusinessLogic.Identity.Resources;
using Idsrv4.Admin.BusinessLogic.Identity.Services;
using Idsrv4.Admin.BusinessLogic.Identity.Services.Interfaces;
using Idsrv4.Admin.EntityFramework.Identity.Repositories;
using Idsrv4.Admin.EntityFramework.Identity.Repositories.Interfaces;
...
public static class AdminServicesExtensions
{
    ...
    public static IServiceCollection AddAdminAspNetIdentityServices<TAdminDbContext, TUserDto, TUserDtoKey, TRoleDto,
        ...
        => services.AddAdminAspNetIdentityServices<TAdminDbContext, TAdminDbContext, TUserDto, TRoleDto,
            TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken,
            TUsersDto, TRolesDto, TUserRolesDto, TUserClaimsDto,
    ...
    public static IServiceCollection AddAdminAspNetIdentityServices<TIdentityDbContext, TPersistedGrantDbContext,
        ...
        where TUserClaimDto : UserClaimDto<TKey>
        where TRoleClaimDto : RoleClaimDto<TKey>
        => AddAdminAspNetIdentityServices<TIdentityDbContext, TPersistedGrantDbContext, TUserDto,
