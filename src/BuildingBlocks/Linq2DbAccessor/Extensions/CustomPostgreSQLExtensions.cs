...
{
    /// <summary>
    /// Postgre SQL 自定义查询函数扩展
    /// </summary>
    public static class CustomPostgreSQLExtensions
    {
        /// <summary>
        /// 查询实体中 jsonb/json 字段中的某个属性
        /// <example>
        /// <para>例如：</para>
        /// <code>
        ...
        public static TJsonProp JsonExtractPathText<TColumn, TJsonProp>(this TColumn field, Expression<Func<TColumn, TJsonProp>> path)
        {
        ...
        /// <returns></returns>
        private static Expression<Func<TColumn, Expression<Func<TColumn, TJsonProp>>, TJsonProp>> JsonExtractPathExpression<TColumn, TJsonProp>()
        {
